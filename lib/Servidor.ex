defmodule Servidor.Chat do
  ...
  def registrar_usuario(nombre) do
    GenServer.call(__MODULE__, {:registrar_usuario, nombre})
  end
  ...
  def unirse_a_sala(nombre_usuario, nombre_sala) do
    GenServer.call(__MODULE__, {:unirse_a_sala, nombre_usuario, nombre_sala})
  end

  # Manejar mensajes
  def manejar_mensajes(sala, mensaje) do
    GenServer.call(__MODULE__, {:mensaje, sala, mensaje})
  end

  # Consultar historial
  def consultar_historial(sala) do
    GenServer.call(__MODULE__, {:consultar_historial, sala})
  end
